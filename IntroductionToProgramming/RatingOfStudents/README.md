Here you can find solution of the task from: 
...
Next 5 fields contain his marks. And the last field contain "TRUE", if this person pays for studying, or "FALSE" if he doesn't. The task is to output in file rating.csv names of top 40% students by average score, 
